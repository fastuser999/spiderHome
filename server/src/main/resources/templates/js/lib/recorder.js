    ...
    function Recorder(source, cfg) {
        ...
        this.worker = new _inlineWorker2.default(function () {
            ...
            function record(inputBuffer) {
				...
				var blob = peekWavBlob('audio/wav');
...
//
//                while (index < length) {
//                    result[index++] = inputL[inputIndex += 3];
////                    result[index++] = inputR[inputIndex += 3];
////                    inputIndex++;
//                }
//                return result;
//            }
            function interleave(inputL, inputR) {
                var compression = 48000/8000;    //计算压缩率 
			...
			function encodePCM(samples) {
            	var sampleBits = 16;
            	var dataLength = samples.length * (sampleBits / 8)*2;
            ...
            function encodeWAV(samples) {
                ...
                view.setUint32(28, sampleRateTmp  *(sampleBits / 8)*numChannels, true);
